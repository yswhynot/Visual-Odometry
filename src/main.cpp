...
//			vector<KeyPoint> keypoints_curr, keypoints_curr_output;
//			Mat descriptors_curr;
//			//		vector<DMatch> matches;
//			vector<DMatch> good_matches_curr;
//			vector<Point2f> good_prev, good_curr, good_prev_filter,
//					good_curr_filter;
...
//						keypoints_curr_output.push_back(keypoints_curr[i]);
//					}
//				}
//
